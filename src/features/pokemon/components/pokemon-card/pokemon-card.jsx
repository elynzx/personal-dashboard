...
export const PokemonCard = ({ pokemon }) => {
    ...
    return (
        ...
        >
            <div className="absolute -top-6 z-10 w-full h-32 flex justify-center items-center pointer-events-none transition-transform duration-300 group-hover:scale-110">
                <img
                    src={image}
                    alt={name}
            ...
            <div className="relative w-full h-35 pb-6 flex flex-col items-center justify-end bg-white/10 backdrop-blur-md border border-white/50 rounded-b-xl  rounded-t-4xl shadow-2xs shadow-white transition-all duration-300 group-hover:bg-white/50 cursor-pointer">
