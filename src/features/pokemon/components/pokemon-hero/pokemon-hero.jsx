        ...
        <div className="flex flex-col items-center animate-fadeIn">
            <div className="relative">
                ...
                <img
                    src={imageUrl}
                    alt={name}
                    className="w-32 h-32 md:w-30 md:h-30 object-contain relative z-20 drop-shadow-lg transition-transform hover:scale-110"
                />
            </div>
            <div className="mt-12 text-center">
                <div className="inline-block bg-white/50 backdrop-blur-sm border border-white px-5 py-0.5 rounded-md mb-3 shadow-sm">
