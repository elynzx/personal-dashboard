...
import { PokemonInfoCard } from "../components/pokemon-info-card/pokemon-info-card";
...
export function PokemonProfilePage() {
    ...
    return (
        <div className="flex-1 w-full rounded-t-xl overflow-y-auto flex flex-col relative font-item scrollbar-hide inset-shadow-sm inset-shadow-bgDarkGray">
            <div className="relative font-item text-[12px] h-22 px-4 md:px-16 bg-bgDarkGray w-full">
                <button
                    onClick={() => navigate(-1)}
