...
export function PokemonProfilePage() {
    ...
    return (
        ...
        >
            <button
                onClick={() => navigate(-1)}
                className="absolute top-14 md:top-8  left-8 z-30 flex items-center gap-2 text-bgDarkGray/60 hover:text-bgDarkGray transition-all cursor-pointer text-xs font-bold uppercase"
            >
                <ArrowLeft size={20} /> Back
            </button>

            <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-18 max-w-5xl mx-auto w-full pt-20 md:pb-10">
